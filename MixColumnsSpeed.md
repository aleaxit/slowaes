In experimenting with Josh Davis' javascript code, I found that using lookup tables for the mixColumns method yielded a 10 times speed increase. The cost is the size of the lookup tables which adds about 4k to the program, but I think the speed improvement is worth it.

I'll put the tables here along with the mixColumn javascript code.
...
The original ruby code where I took this from was written by Alex Boussinet and can be found at http://rubyforge.org/projects/ruby-aes.